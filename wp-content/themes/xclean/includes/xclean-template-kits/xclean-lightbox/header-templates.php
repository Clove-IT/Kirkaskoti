...
?>
<script type="text/template" id="tmpl-xclean-header-templates">
		...
		<div class="elementor-templates-modal__header__items-area">
			<# if ( data.closeType ) { #>
				<div class="elementor-templates-modal__header__close elementor-templates-modal__header__close--{{{ data.closeType }}} elementor-templates-modal__header__item" style="border-left: none;">
					...
					<span><?php echo esc_html__( 'Skip', 'xclean' ); ?></span>
					<# } #>
					<i class="eicon-close" aria-hidden="true" title="<?php echo esc_attr__( 'Close', 'xclean' ); ?>" style="color: #fff"></i>
					<span class="elementor-screen-only"><?php echo esc_html__( 'Close', 'xclean' ); ?></span>
				</div>
			<# } #>
