 ...
 */
class PBMIT_PortfolioElement extends Widget_Base{
 	// The get_name() method is a simple one, you just need to return a widget name that will be used in the code.
	public function get_name() {
		return 'pbmit_portfolio_element';
	}
	// The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
	public function get_title() {
		// Portfolio
		$portfolio_cpt_singular_title	= esc_attr__('Portfolio','xclean');
		$portfolio_cpt_singular_title2	= get_theme_mod( 'portfolio-cpt-singular-title' );
		...
		return sprintf( esc_attr__( 'Xclean %1$s Element', 'xclean' ), $portfolio_cpt_singular_title );
	}
	...
	protected function register_controls() {
		// Portfolio
		$portfolio_cpt_title	= esc_attr__('Portfolio','xclean');
		$portfolio_cpt_title2	= get_theme_mod( 'portfolio-cpt-title' );
		...
		$portfolio_cat_singular_title2	= get_theme_mod( 'portfolio-cat-singular-title' );
		...
		$this->start_controls_section(
			'style_section',
			[
				'label'	=> sprintf( esc_attr__( '%1$s Style Options', 'xclean' ), $portfolio_cpt_singular_title ),
		...
		$this->add_control(
			'style',
			[
				'label'			=> sprintf( esc_attr__( 'Select %1$s View Style', 'xclean' ), $portfolio_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'Select %1$s View Style', 'xclean' ), $portfolio_cpt_singular_title ),
				'type'			=> 'pbmit_imgselect',
				'label_block'	=> true,
				'thumb_width'	=> '110px',
				'default'		=> '1',
				'options'		=> pbmit_element_template_list( 'portfolio', true ),
			]
		);
		...
		$this->add_control(
			'view-type',
			[
				'label'			=> sprintf( esc_attr__( 'How you like to view each %1$s box?', 'xclean' ), $portfolio_cpt_singular_title ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'Set to YES to enable continuous loop mode. Set NO to enable rewind loop mode.', 'xclean' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '1',
				'options'		=> [
					'1'				=> esc_attr__( 'Yes', 'xclean' ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> sprintf(esc_attr__( 'Select YES to dynamically load more %1$s', 'xclean' ), $portfolio_cpt_title ),
		...
		$this->add_control(
			...
			[
				...
				'default'		=> sprintf( esc_attr__( 'Our %1$s', 'xclean' ), $portfolio_cpt_singular_title ),
		...
		$this->start_controls_section(
			'data_section',
			[
				'label' => sprintf( esc_attr__( '%1$s Content Options', 'xclean' ), $portfolio_cpt_singular_title ),
			]
		);
		$this->add_control(
			'from_category',
			[
				'label'			=> sprintf( esc_attr__( 'Show %2$s from selected %2$s?', 'xclean' ), $portfolio_cpt_singular_title, $portfolio_cat_singular_title ),
		...
		$this->add_control(
			'show',
			[
				'label'			=> sprintf( esc_attr__( '%1$s to show', 'xclean' ), $portfolio_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'How many %1$s you want to show.', 'xclean' ), $portfolio_cpt_singular_title ),
				'separator'		=> 'before',
		...
		$this->add_control(
			'sortable',
			[
				'label'			=> sprintf( esc_attr__( 'Show Sortable %1$s?', 'xclean' ), $portfolio_cat_singular_title ),
				'description'	=> sprintf( esc_attr__( 'Select YES to show sortable %1$s.', 'xclean' ), $portfolio_cat_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xclean' ),
				'label_off'		=> esc_attr__( 'No', 'xclean' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'	=> sprintf( esc_attr__( 'Select YES to load %1$s using Ajax on click on the category.', 'xclean' ), $portfolio_cat_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xclean' ),
				'label_off'		=> esc_attr__( 'No', 'xclean' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'	=>  sprintf( esc_attr__( 'Select YES to Show pagination links below %1$s boxes.', 'xclean' ), $portfolio_cat_singular_title  ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xclean' ),
				'label_off'		=> esc_attr__( 'No', 'xclean' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'	=>  sprintf( esc_attr__( 'Select YES to load Posts without page refresh (ajax based) when click on the pagination links.', 'xclean' ), $portfolio_cat_singular_title  ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xclean' ),
				'label_off'		=> esc_attr__( 'No', 'xclean' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'	=> sprintf( esc_attr__( ' Sort retrieved %1$s by parameter.', 'xclean' ), $portfolio_cpt_singular_title ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> 'none',
				'options'		=> [
		...
		$this->add_control(
			'offset',
			[
				'label'			=> sprintf( esc_attr__( 'Skip %1$s (offset)', 'xclean' ), $portfolio_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'How many %1$s you like to skip.', 'xclean' ), $portfolio_cpt_singular_title ),
				'type'			=> Controls_Manager::SELECT,
				'label_block'	=> true,
				'default'		=> '',
				'options'		=> [
					''			=> sprintf( esc_attr__( 'Show All %1$s (No skip)', 'xclean' ), $portfolio_cpt_singular_title ),
					'1'			=> sprintf( esc_attr__( 'Skip first %1$s', 'xclean' ), $portfolio_cpt_singular_title ),
					'2'			=> sprintf( esc_attr__( 'Skip two %1$s', 'xclean' ), $portfolio_cpt_title ),
					'3'			=> sprintf( esc_attr__( 'Skip three %1$s', 'xclean' ), $portfolio_cpt_title ),
					'4'			=> sprintf( esc_attr__( 'Skip four %1$s', 'xclean' ), $portfolio_cpt_title ),
					'5'			=> sprintf( esc_attr__( 'Skip five %1$s', 'xclean' ), $portfolio_cpt_title ),
				],
				'condition'	=> [
					'pagination!'		=> 'yes',
					'ajax_pagination!'	=> 'yes',
		...
		$this->add_control(
			'gap_options',
			[
				'label'		=> sprintf( esc_attr__( 'Gap between %1$s boxes', 'xclean' ), $portfolio_cpt_singular_title ),
				'type'		=> Controls_Manager::HEADING,
				'separator'	=> 'before',
			]
		);
		$this->add_control(
			...
			[
				...
				'description'	=>  sprintf( esc_attr__( 'Gap between each %1$s box.', 'xclean' ), $portfolio_cpt_singular_title ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> 'default',
				'options'		=> [
	...
	protected function render() {
		...
		if( $style == '2' && $settings['view-type'] =='carousel'){
			$masonry_image_size_array = array(
				'pbmit-img-610x405', // For masonry 1st box
				'pbmit-img-610x405', // For masonry 3st box				
				'pbmit-img-610x830', // For masonry 2nd box
			);
		} 
		$swiper_class = '';
		...
		<div class="pbmit-ele-header-area">
			...
			<?php
			/* Sortable Category  */
			$sortable_html = pbmit_sortable_category( $settings, 'pbmit-portfolio-category' );
		...
		$infinite_scroll_data['cpt'] = 'portfolio';
		...
		if ( $posts->have_posts() ) {
			...
			?>
				<div class="pbmit-element-posts-wrapper row multi-columns-row <?php if( !empty($settings['view-type']) && trim($settings['view-type'])=='carousel' ){ ?>swiper-container<?php } ?>" <?php if( !empty($dot_text) ) { ?> data-cursor-text="<?php echo esc_attr($dot_text); ?>"<?php } ?> >
					<?php
					$odd_even		= 'odd';
					$col_odd_even	= 'odd';
					$x				= 1;
					$every_three	= 1; // Specially for portfolio style 14
					...
					while ( $posts->have_posts() ) {
						...
						// Specially for portfolio style 2
						if( $style == '2' ){
							if( !empty($settings['view-type']) && trim($settings['view-type'])=='carousel' ){
								if( $every_three == 1 || $every_three == 3 ){
									echo pbmit_esc_kses('<div class="pbmit-ele-group-wrapper">');
								}
							}
						}
						...
						if( $style == '2' ){
							if( !empty($settings['view-type']) && trim($settings['view-type'])=='carousel' ){
								if( $every_three == 2 || $every_three == 3 || $x == $total_posts ){
...
Plugin::instance()->widgets_manager->register( new PBMIT_PortfolioElement() );