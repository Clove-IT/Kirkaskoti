...
class PBMIT_TeamElement extends Widget_Base{
	...
	public function get_title() {
		// team
		$team_cpt_singular_title	= esc_attr__('Team','xclean');
		...
		return sprintf( esc_attr__( 'Xclean %1$s Element', 'xclean' ), $team_cpt_singular_title );
	}
	...
	protected function register_controls() {
		// Team
		$team_cpt_title		= esc_attr__('Team Members','xclean');
		...
		$team_cpt_singular_title2	= get_theme_mod( 'team-cpt-singular-title' );
		$team_cpt_singular_title	= ( !empty($team_cpt_singular_title2) ) ? $team_cpt_singular_title2 : $team_cpt_singular_title ;
		$team_cat_singular_title	= esc_attr__('Team Group','xclean');
		...
		$this->start_controls_section(
			'style_section',
			[
				'label'	=> sprintf( esc_attr__( '%1$s Style Options', 'xclean' ), $team_cpt_singular_title ),
		...
		$this->add_control(
			'style',
			[
				'label'			=> sprintf( esc_attr__( 'Select %1$s View Style', 'xclean' ), $team_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'Select %1$s View Style', 'xclean' ), $team_cpt_singular_title ),
		...
		$this->add_control(
			'view-type',
			[
				'label'			=> sprintf( esc_attr__( 'How you like to view each %1$s box?', 'xclean' ), $team_cpt_singular_title ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=>  sprintf( esc_attr__( 'Select YES to dynamically load more %1$s', 'xclean' ), $team_cpt_title ),
		...
		$this->add_control(
			...
			[
				...
				'default'		=> sprintf( esc_attr__( 'Our %1$s', 'xclean' ), $team_cpt_singular_title ),
		...
		$this->start_controls_section(
			'data_section',
			[
				'label'	=> sprintf( esc_attr__( '%1$s Content Options', 'xclean' ), $team_cpt_singular_title ),
			]
		);
		$this->add_control(
			'from_category',
			[
				'label'			=> sprintf( esc_attr__( 'Show %2$s from selected %1$s?', 'xclean' ), $team_cpt_singular_title , $team_cat_singular_title ),
		...
		$this->add_control(
			'show',
			[
				'label'			=> sprintf( esc_attr__( '%1$s to show', 'xclean' ), $team_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'How many %1$s you want to show.', 'xclean' ), $team_cpt_singular_title ),
				'separator'		=> 'before',
		...
		$this->add_control(
			'sortable',
			[
				'label'			=> sprintf( esc_attr__( 'Show Sortable %1$s?', 'xclean' ), $team_cat_singular_title ),
				'description'	=> sprintf( esc_attr__( 'Select YES to show sortable %1$s.', 'xclean' ), $team_cat_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xclean' ),
				'label_off'		=> esc_attr__( 'No', 'xclean' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'	=> sprintf( esc_attr__( 'Select YES to load %1$s using Ajax on click on the category.', 'xclean' ), $team_cat_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xclean' ),
				'label_off'		=> esc_attr__( 'No', 'xclean' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'	=>  sprintf( esc_attr__( 'Select YES to Show pagination links below %1$s boxes.', 'xclean' ), $team_cpt_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xclean' ),
				'label_off'		=> esc_attr__( 'No', 'xclean' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'	=>  sprintf( esc_attr__( 'Select YES to load Posts without page refresh (ajax based) when click on the pagination links.', 'xclean' ), $team_cpt_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xclean' ),
				'label_off'		=> esc_attr__( 'No', 'xclean' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'	=> sprintf( esc_attr__( ' Sort retrieved %1$s by parameter.', 'xclean' ), $team_cat_singular_title ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> 'none',
				'options'		=> [
		...
		$this->add_control(
			'offset',
			[
				'label'			=> sprintf( esc_attr__( 'Skip %1$s (offset)', 'xclean' ), $team_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'How many %1$s you like to skip.', 'xclean' ), $team_cpt_singular_title ),
				'type'			=> Controls_Manager::SELECT,
				'label_block'	=> true,
				'default'		=> '',
				'options'		=> [
					''			=> sprintf( esc_attr__( 'Show All %1$s (No skip)', 'xclean' ), $team_cpt_singular_title ),
					'1'			=> sprintf( esc_attr__( 'Skip first %1$s', 'xclean' ), $team_cpt_singular_title ),
					'2'			=> sprintf( esc_attr__( 'Skip two %1$s', 'xclean' ), $team_cpt_title ),
					'3'			=> sprintf( esc_attr__( 'Skip three %1$s', 'xclean' ), $team_cpt_title ),
					'4'			=> sprintf( esc_attr__( 'Skip four %1$s', 'xclean' ), $team_cpt_title ),
					'5'			=> sprintf( esc_attr__( 'Skip five %1$s', 'xclean' ), $team_cpt_title ),
				],
				'condition'	=> [
					'ajax_sortable!' => 'yes',
				]
		...
		$this->add_control(
			'gap_options',
			[
				'label'		=> sprintf( esc_attr__( 'Gap between %1$s boxes', 'xclean' ), $team_cpt_singular_title ),
				'type'		=> Controls_Manager::HEADING,
				'separator'	=> 'before',
			]
		);
		$this->add_control(
			...
			[
				...
				'description'	=>  sprintf( esc_attr__( 'Gap between each  %1$s box.', 'xclean' ), $team_cpt_singular_title ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> 'default',
				'options'		=> [
			...
			<div class="pbmit-element-posts-wrapper row multi-columns-row <?php if( !empty($settings['view-type']) && trim($settings['view-type'])=='carousel' ){ ?>swiper-container<?php } ?>">
				...
				while ( $posts->have_posts() ) {
					...
					if( file_exists( locate_template( '/theme-parts/team/team-style-'.esc_attr($style).'.php', false, false ) ) ){
						...
						ob_start();
						include( locate_template( '/theme-parts/team/team-style-'.esc_attr($style).'.php', false, false ) );
