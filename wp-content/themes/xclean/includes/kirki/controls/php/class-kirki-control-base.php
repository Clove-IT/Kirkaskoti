	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'	   => esc_html__( 'No File Selected', 'xclean' ),
				'remove'			   => esc_html__( 'Remove', 'xclean' ),
				'default'			  => esc_html__( 'Default', 'xclean' ),
				'selectFile'		   => esc_html__( 'Select File', 'xclean' ),
				'standardFonts'		=> esc_html__( 'Standard Fonts', 'xclean' ),
				'googleFonts'		  => esc_html__( 'Google Fonts', 'xclean' ),
				'defaultCSSValues'	 => esc_html__( 'CSS Defaults', 'xclean' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'xclean' ),
			)
		);
