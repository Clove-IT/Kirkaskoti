...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'xclean' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'xclean' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'xclean' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'xclean' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'xclean' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'xclean' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'xclean' ); ?>',
} );
#>
<label>
