...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'	   => esc_html__( 'Select image', 'xclean' ),
				'change'	   => esc_html__( 'Change image', 'xclean' ),
				'default'	  => esc_html__( 'Default', 'xclean' ),
				'remove'	   => esc_html__( 'Remove', 'xclean' ),
				'placeholder'  => esc_html__( 'No image selected', 'xclean' ),
				'frame_title'  => esc_html__( 'Select image', 'xclean' ),
				'frame_button' => esc_html__( 'Choose image', 'xclean' ),
			)
		);
	}
	/**
