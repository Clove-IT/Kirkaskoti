...
final class Kirki_Fonts {
	...
	public static function get_google_fonts() {
		 ...
		 */
		if ( ! empty( $_GET['action'] ) && 'kirki-reset-cache' === sanitize_text_field($_GET['action']) ) { // phpcs:ignore WordPress.Security.NonceVerification
	...
	public static function get_all_variants() {
		return array(
			'100'	   => esc_html__( 'Ultra-Light 100', 'xclean' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'xclean' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'xclean' ),
			'200'	   => esc_html__( 'Light 200', 'xclean' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'xclean' ),
			'300'	   => esc_html__( 'Book 300', 'xclean' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'xclean' ),
			'400'	   => esc_html__( 'Normal 400', 'xclean' ),
			'regular'   => esc_html__( 'Normal 400', 'xclean' ),
			'italic'	=> esc_html__( 'Normal 400 Italic', 'xclean' ),
			'500'	   => esc_html__( 'Medium 500', 'xclean' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'xclean' ),
			'600'	   => esc_html__( 'Semi-Bold 600', 'xclean' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'xclean' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'xclean' ),
			'700'	   => esc_html__( 'Bold 700', 'xclean' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'xclean' ),
			'800'	   => esc_html__( 'Extra-Bold 800', 'xclean' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'xclean' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'xclean' ),
			'900'	   => esc_html__( 'Ultra-Bold 900', 'xclean' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'xclean' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'xclean' ),
		);
	}
	/**
