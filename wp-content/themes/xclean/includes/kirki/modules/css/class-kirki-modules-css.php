...
class Kirki_Modules_CSS {
	...
	public function print_styles_action() {
		 ...
		 */
		if ( empty( $_GET['action'] ) || apply_filters( 'kirki_styles_action_handle', 'kirki-styles' ) !== sanitize_text_field($_GET['action']) ) { // phpcs:ignore WordPress.Security.NonceVerification
			return;
		}
