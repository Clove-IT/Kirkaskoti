...
<div class="pbmit-post-item">
	...
	<div class="pbmit-content-wrapper">
		...
		<a class="pbmit-blog-btn" href="<?php the_permalink(); ?>" title="<?php echo get_the_title(); ?>"><span class="pbmit-button-text"><?php esc_html_e('Contact Us', 'xclean'); ?></span><span class="pbmit-button-icon-wrapper"><span class="pbmit-button-icon"><i class=" pbmit-base-icon-black-arrow-1"></i></span></span></a>
	</div>
</div>