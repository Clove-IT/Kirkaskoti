	...
	<div class="pbmit-blog-classic">
		...
		<div class="pbmit-blog-classic-inner">
			...
			<div class="pbmit-entry-content">
				...
				if( get_post_format()!='quote' ){
					if( is_single() ){
						...
						if ( has_excerpt() ){
							the_excerpt();
							?>
							<div class="pbmit-read-more-link"><a class="pbmit-btn" href="<?php the_permalink(); ?>"><span class="pbmit-button-text"><?php esc_html_e('Read More','xclean') ?></span><span class="pbmit-button-icon-wrapper"><span class="pbmit-button-icon"><i class="pbmit-base-icon-black-arrow-1"></i></span></span></a></div>
							<?php
				...
				wp_link_pages( array(
					'before'	  => '<div class="page-links">' . esc_attr__( 'Pages:', 'xclean' ),
					'after'	   => '</div>',
