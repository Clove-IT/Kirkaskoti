	...
	<div class="pbmit-author-box">
		...
		<div class="pbmit-author-content">
			<span class="pbmit-author-name">
				<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php printf( esc_attr__('Posted by %1$s','xclean'), get_the_author() ); ?>" rel="author"><?php echo get_the_author(); ?></a>
			</span>
