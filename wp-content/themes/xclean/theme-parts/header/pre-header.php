			...
			<div class="pbmit-pre-header-content d-flex justify-content-between">
				...
				if( !empty($preheader_right) || $preheader_search==true ){ ?>
					<div class="pbmit-pre-header-right">
						...
						<?php if( $preheader_search==true ) { echo pbmit_esc_kses( '<div class="pbmit-header-search-btn"><a title="'.esc_attr__('Search','xclean') .'" href="#"><i class="pbmit-base-icon-search"></i></a></div>' ); } ?>
